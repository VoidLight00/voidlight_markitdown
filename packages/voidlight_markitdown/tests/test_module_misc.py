...
from voidlight_markitdown._uri_utils import parse_data_uri, file_uri_to_path
...
def test_docx_comments() -> None:
    ...
    markitdown_with_style_map = VoidLightMarkItDown(style_map="comment-reference => ")
...
def test_markitdown_exiftool() -> None:
    ...
    markitdown = VoidLightMarkItDown(exiftool_path=which_exiftool)
...
def test_markitdown_llm() -> None:
    ...
    markitdown = VoidLightMarkItDown(llm_client=client, llm_model="gpt-4o")
