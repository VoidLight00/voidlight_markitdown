...
from ..utils.uri_utils import parse_data_uri, file_uri_to_path
from ..korean.utils import KoreanTextProcessor
from ..utils.logging import get_logger, log_performance, LoggingMixin, setup_logging
...
def _load_plugins() -> Union[None, List[Any]]:
    ...
    # Load plugins
    _plugins = []
    for entry_point in entry_points(group="voidlight_markitdown.plugin"):
        try:
...
class VoidLightMarkItDown(LoggingMixin):
    ...
    VoidLight edition with enhanced Korean language processing capabilities."""
