...
from ..core.exceptions import MissingDependencyException
...
def transcribe_audio(file_stream: BinaryIO, *, audio_format: str = "wav") -> str:
    ...
    if _dependency_exc_info is not None:
        raise MissingDependencyException(
            "Speech transcription requires installing VoidlightMarkItdown with the [audio-transcription] optional dependencies. E.g., `pip install voidlight_markitdown[audio-transcription]` or `pip install voidlight_markitdown[all]`"
